...
@InputType()
class DonationCreateNestedManyWithoutFundraisersInput {
...
export { DonationCreateNestedManyWithoutFundraisersInput as DonationCreateNestedManyWithoutFundraisersInput };
