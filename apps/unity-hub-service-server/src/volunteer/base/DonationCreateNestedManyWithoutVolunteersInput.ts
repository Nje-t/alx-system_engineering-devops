...
@InputType()
class DonationCreateNestedManyWithoutVolunteersInput {
...
export { DonationCreateNestedManyWithoutVolunteersInput as DonationCreateNestedManyWithoutVolunteersInput };
